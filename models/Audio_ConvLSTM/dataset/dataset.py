...
if __name__ == '__main__':
    ...
    root_dir = '/cvhci/temp/wpingcheng/DAIC_WOZ-generated_database_V2/test/clipped_data/'

    # test 3: try to load the dataset with DataLoader
    transformed_dataset = DepressionDataset(root_dir, 'test',
                                            transform=transforms.Compose([ToTensor('test')]))  # Rescale((80, 900)), Padding((90, 900)), 
