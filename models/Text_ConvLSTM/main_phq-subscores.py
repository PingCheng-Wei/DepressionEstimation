...
def main(dataloaders, text_net, evaluator, base_logger, writer, config, args, model_type, ckpt_path):
    ...
    model_parameters = [*text_net.parameters()] + [*evaluator.parameters()]
...
if __name__ == '__main__':
    ...
    text_net, evaluator = get_models(config['MODEL'], args, model_type, ckpt_path)

    main(dataloaders, text_net, evaluator, base_logger, writer, config['MODEL'], args, model_type, ckpt_path)
