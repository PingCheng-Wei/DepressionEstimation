...
def get_models(model_config, args, model_type=None, ckpt_path=None):
    ...
    # weights_path_text = '/home/wpingcheng/Models/depression_classifier_new/Text_ConvLSTM/model_weights/T+Conv1D-BiLSTM+PHQ-Subscores_2022-03-22_084342_acc-50.8163.pt'
    # checkpoint = torch.load(weights_path_text)
    # print("Loading Deep Text Net weights from {}".format(weights_path_text))
    ...
    return visual_net, audio_net, text_net, fusion_net, evaluator
